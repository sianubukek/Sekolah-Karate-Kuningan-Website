        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="space-y-2 text-sm">
              ...
              <a href="/kontak" className="block text-gray-300 hover:text-skk-red transition-colors">Kontak</a>
            </div>
          </motion.div>
        </div>
