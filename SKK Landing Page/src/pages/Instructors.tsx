  ...
  const instructors = [
    {
      ...
      specialty: "Pendiri SKK & Guru Besar",
      description: "Pemegang sabuk hitam Dan 3 dengan pengalaman mengajar lebih dari 30 tahun. Spesialis dalam teknik kumite dan kihon dasar.",
      achievements: ["Juara 1 Asia Pacific 1991"],
      image: "/Heni.jpeg"
    }
  ];
